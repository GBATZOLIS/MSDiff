...
def get_config():
  ...
  training.conditioning_approach = '5'
  ...
  model.checkpoint_path = '/home/gb511/SDE_replicas/interpolation/inpainting/5/lightning_logs/version_1/checkpoints/epoch=219-step=356998.ckpt'
