...
def get_config():
  ...
  training.conditioning_approach = '9'
  ...
  model.checkpoint_path = '/home/gb511/SDE_replicas/interpolation/inpainting/9/lightning_logs/version_1/checkpoints/epoch=219-step=356998.ckpt'
