...
def get_config():
  ...
  evaluate.first_test_batch = 40
  evaluate.last_test_batch = 120
  ...
  model.checkpoint_path = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/checkpoints/super-resolution/celebA-HQ-160/song/epoch=87-step=447655.ckpt'
