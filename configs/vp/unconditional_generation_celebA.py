...
def get_config():
  ...
  #logging
  config.base_log_path = 'experiments' #'/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/mri_to_pet/experiments'
  ...
  data.base_dir = 'dataset' #'/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/datasets'
