...
def get_config():
  ...
  #logging
  config.base_log_path = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/fast_reverse_diffusion/multiscale/celebA-HQ'
  config.experiment_name = 'multiscale_256'
  ...
  data.image_size = data.target_image_size//2**data.scale_depth
