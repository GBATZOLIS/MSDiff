...
def get_config():
  ...
  training.gpus = 1
  training.batch_size = 16 // (training.num_nodes*training.gpus) #64
  ...
  if server == 'hpc':
    checkpt = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/fast_reverse_diffusion/multiscale/celebA-HQ/OpenAI_architecture/128/vanilla/checkpoint_collection/step=669999.ckpt'
  elif server == 'abg':
    checkpt = '/home/gb511/projects/fast_sampling/celebA-HQ/128/checkpoints/step=669999.ckpt'

  model.checkpoint_path = checkpt
