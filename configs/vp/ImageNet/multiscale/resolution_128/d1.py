...
def get_config():
  ...
  training.gpus = 2
  training.batch_size = 12 // (training.num_nodes*training.gpus) #128 // (training.num_nodes*training.gpus)
  ...
  model.checkpoint_path = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/fast_reverse_diffusion/multiscale/ImageNet/128/multiscale/checkpoint_resuming/latest-step=4999.ckpt'
