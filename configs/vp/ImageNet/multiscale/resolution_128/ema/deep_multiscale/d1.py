...
def get_config():
  ...
  config.experiment_name = 'multiscale_ema_deep'
  ...
  evaluate.checkpoint_iterations = [2529999] 
  evaluate.checkpoint_iteration = None
  evaluate.base_checkpoint_path =  '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/fast_reverse_diffusion/multiscale/ImageNet/128/multiscale_ema_deep/checkpoint_collection'

  evaluate.num_samples = 20000
  evaluate.probability_flow = False
  evaluate.predictor = ['reverse_diffusion']
  evaluate.corrector = 'none'
  evaluate.p_steps = [128, 256, 512, 1000] 
  evaluate.c_steps = 1
  ...
  model.checkpoint_path = '/home/gb511/rds/rds-t2-cs138-LlrDsbHU5UM/gb511/projects/fast_reverse_diffusion/multiscale/ImageNet/128/multiscale_ema_deep/checkpoint_resuming/latest-step=2479999.ckpt'
