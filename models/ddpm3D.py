...
class DDPM3D(pl.LightningModule):
  def __init__(self, config):
    ...
    ResnetBlock = functools.partial(ResnetBlockDDPM, act=act, temb_dim=4 * nf, conv_shortcut=True, dropout=dropout, dim=3)
    if conditional:
...
@utils.register_model(name='ddpm3D_paired')
class DDPM3D_paired(DDPM3D):
